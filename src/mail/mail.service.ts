...
export class MailService {
  ...
  /**
   * Sending set password template
   * @param email email of the user
   * @param setPasswordLink link with id of the user and reset password token
   */
  public async sendsetPasswordTemplate(email: string, setPasswordLink: string) {
    try {
      await this.mailerService.sendMail({
        to: email,
        from: `<no-reply@my-nestjs-app.com>`,
